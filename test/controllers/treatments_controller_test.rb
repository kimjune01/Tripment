...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { average_price: @treatment.average_price, name: @treatment.name } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { average_price: @treatment.average_price, name: @treatment.name } }
