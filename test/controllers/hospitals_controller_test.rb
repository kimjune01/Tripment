...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { capacity: @hospital.capacity, conditions: @hospital.conditions, email: @hospital.email, location: @hospital.location, name: @hospital.name } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { capacity: @hospital.capacity, conditions: @hospital.conditions, email: @hospital.email, location: @hospital.location, name: @hospital.name } }
